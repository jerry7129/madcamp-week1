...
| :---: | :---: | :---: | :---: | :---: |
| **지도 & 내 위치 추적**<br>실시간 마커 배지 확인<br>Follow 모드로 주변 탐색 | **스마트 검색**<br>지역/카페명 검색 및 이동<br>카페 정보 및 <br>네이버 플레이스 연결 | **리스트 보기 & 정렬**<br>별점/재고순 필터링<br>별점 부여 | **관리자 권한 획득**<br>소셜 로그인 사용<br>Kakao, Google | **카페 및 재고 관리**<br>카페 등록<br>카페 삭제<br>실시간 수량 업데이트 |
